      ...
      <div className="flex flex-col gap-8 pt-32">
        ...
        <div className="flex flex-col gap-4 px-8 max-w-4xl md:max-w-none mx-auto">
          ...
          <p className="text-center text-pri font-noto-sans font-extralight text-sm md:text-lg">
            ...
            disesuaikan dengan kebutuhan, tingkat kebugaran, dan aspirasi Anda.
          </p>
          <p className="text-center text-pri font-noto-sans font-extralight text-sm md:text-lg">
            Dari program penurunan berat badan yang efektif, pembentukan otot
            yang terarah, hingga peningkatan stamina dan fleksibilitas, pelatih
            kami akan mendampingi Anda di setiap langkah. Dapatkan panduan
            nutrisi, teknik latihan yang benar, dan motivasi tanpa batas untuk
            memastikan Anda tidak hanya meraih hasil, tetapi juga mempertahankan
            gaya hidup sehat dalam jangka panjang.
          </p>
        </div>
      </div>
      {/* Section1 */}
